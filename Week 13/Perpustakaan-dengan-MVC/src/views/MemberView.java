...
public class MemberView extends JFrame {
    ...
    public MemberView(VisitorEntity member){
        this.member = member;
        initWindow();
        initComponent();
        initEvent();
    ...
    private void initComponent(){
        ...
        table.setModel(new VisitorController().getTable(this.member.getIdKtp()));
    ...
    private void initEvent(){
        btnback.addActionListener(e -> {
            dispose();
            new VisitorController().viewHome();
        });
    }
}
