...
import Controllers.RegisterMemberController;
    ...
    private void initEvent(){
        ...
        btnok.addActionListener(e -> {
            if(nama.getText().length()!=0 && no_ktp.getText().length()!=0 && alamat.getText().length()!=0){
                MemberEntity vs = new MemberEntity(nama.getText(),no_ktp.getText(),alamat.getText());
                int cek = new RegisterMemberController().reg(vs);
                if(cek != -1){
